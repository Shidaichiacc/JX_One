...
----------------------
function StarterGuide_Main()
		dofile("script/global/mel/item/camnangdonghanh_test.lua")
	...
	if (CFG_ChayThuNghiem == 0) then
		...
		{"Chuc nang cu / Event", LegacyMerged_Main},
...
-- ============================================================================
-- 18. LEGACY / EVENT / TEST FUNCTIONS MERGED FROM npcthunghiem.lua
-- Kept separate to avoid overriding current implementations.
-- ============================================================================
function LegacyMerged_Main()
	local tbOpt = {
		{"Test thuong hoat dong", activity_bonus},
		{"Trang bi Hoang Kim Event", trangbiHK_event},
		{"Trang bi Hoang Kim Super", trangbiHK_Super},
		{"Khoang thach co thuoc tinh", KhoangThach2},
		{"Item Tet 2008", List_Item_tet2008},
		{"Item Noel 2007", List_Item_noel2007},
		{"Item Noel 2006", List_Item_noel2006},
		{"Lay do RES (test)", LayDoRes},
		{"Trieu tap dong doi", GoiPTToiNoi},
		{"Tro lai", main},
		{"Thoat"},
	}
	CreateNewSayEx("Chuc nang cu / Event / Test:", tbOpt)
end
