...
-- Viem De
function ViemDe()
	OutputMsg("===> Khoi dong Viem De [GM]")
	GlobalExecute("dwf \\script\\missions\\yandibaozang\\yandibaozang_trigger.lua YDBZ_OnTrigger()")
	GlobalExecute(format("dw Msg2SubWorld([[%s]])", "<color=yellow>Viem De<color> da bat dau bao danh, hay gap Binh Binh Co Nuong de tham gia."))
end
